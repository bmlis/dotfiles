...
alias ls="ls --color"
alias rebuild="sudo nix run nix-darwin/nix-darwin-25.05#darwin-rebuild -- switch --flake ~/.config/nix#mbp"
alias pckg-update="cd ~/.config/nix && nix flake update && rebuild"
source $HOME/.aliases
